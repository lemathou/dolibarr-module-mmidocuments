...
/**
 * \file    test/phpunit/MMIDocumentsFunctionalTest.php
...
/**
 * Class MMIDocumentsFunctionalTest
 *
 ...
 *
 * @package Testmmidocuments
 */
class MMIDocumentsFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modMMIDocuments')->click();
		} else {
			// Disable the module
			$this->byHref('modMMIDocuments')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/mmidocuments/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('mmidocuments/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/mmidocuments/admin/about.php');
		$this->authenticate();
		return $this->assertContains('mmidocuments/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('mmidocumentswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMMIDocuments_MMIDocumentsTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMMIDocuments_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
